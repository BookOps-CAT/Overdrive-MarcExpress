        ...
        for bib in reader:
            ...
            if not has_overdriveNo(bib):
                ...
                if oid is not None:
                    ...
                    save2marc("./marc/NYPL/nyp-sierra-037-added.mrc")
                else:
                    save2marc("./marc/NYPL/nyp-sierra-037-impossible.mrc", bib)
                    unable_oid += 1
            else:
                save2marc(marc_out, bib)
...
if __name__ == "__main__":
    process(
        "./marc/NYPL/orig/sierra-nyp-all.mrc",
        "./marc/NYPL/sierra-nyp-all-prepped.mrc",
    )
